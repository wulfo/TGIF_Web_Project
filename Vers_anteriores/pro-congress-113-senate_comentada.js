...
//-------mi solucion inicial para la tabla sin links----
...
//
//
//---------------fin solucion inicial para la tabla-----

//------------Mi solucion anterior con links--------------
...
// FUNCION DROPDOWN
function states(members) { // funcion para crear la lista de State
    ...
    for (var a = 0; a < members.length; a++) { //corremos el lop para todo los datos de los miembros.

        var allStates = members[a].state; //y el resultado de todos los miembros de state (.state) lo almacenamos en ela Variable
